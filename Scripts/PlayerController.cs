...
public class PlayerController : Subject
{
    ...
    public int badCollect;
    public int badCollectMax = 3;
    ...
    void Update()
    {
        ...
        curTimeText.text = ((Time.time - startTime) + badCollect).ToString("F2");
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("AddTime"))
        {
            ...
            if(badCollect == badCollectMax)
            {
                End();
                curTimeText.text = "YOU FAILED";
            }
        }
    }
